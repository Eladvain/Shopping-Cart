...
feedback::feedback(const char* date, const  consumer* cons, const  F_evaluaton& evaluation,const string& name)//consrtuctor
{
	F_init(date, cons, evaluation,name);
}
//_____________________________________________________________________________________________________________________________
void feedback::F_init(const char* date,const  consumer* cons,const  F_evaluaton& evaluation, const string& name)
{
	F_setCosumer(cons);
	F_setDate(date);
...
//_____________________________________________________________________________________________________________________________
void feedback::F_setUserName(const string& name)
{
	F_consumerToFeedback = name;
}
//_____________________________________________________________________________________________________________________________
