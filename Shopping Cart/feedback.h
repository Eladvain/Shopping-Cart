...
public:
	...
	feedback(const char* date="notGiven" , const  consumer* cons=nullptr, const  F_evaluaton& evaluation=(F_evaluaton)2, const string& name="notgiven");
	void F_init(const char* date, const consumer* cons, const  F_evaluaton& evaluation,const string& sellerUserNmae);
	...
	void F_setUserName(const string& name);
